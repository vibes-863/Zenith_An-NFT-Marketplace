...
<body>
  ...
  <div className="container1">
    <div className="column">
      <div className="u-aspect-16-9" style={{ width:'fit-content', margin:'auto', }}><iframe className="u-aspect-16-9__inner"
    ...
    <div className="column">
      <div className="left-right-col left-right-col--2" style={{ textAlign:"center", }}>
        <h2 className="left-right-col__title t-title-2 t-bold a-fade-up" style={{ fontSize:50, }}>What Exactly is Web 3.0?
        </h2>
        <p className="left-right-col__subtitle t-title-2 t-bold t-light-gray a-fade-up" style={{ transitionDelay:"100ms", }}>
          Juan Benet</p>
        <p className="left-right-col__content t-sm a-fade-up" style={{ transitionDelay:"200ms", margin:"0 auto", }}>Juan Benet,
          founder and
  ...
  <div className="holder">
    ...
    <p>An NFT, or non-fungible token, is a type of digital asset that represents ownership or proof of authenticity of a
    ...
    <p>One of the key features of NFTs is that they allow creators and artists to monetize their digital works directly,
  ...
  <div className="container">
    <div className="embed-responsive embed-responsive-16by9" style={{ width:"fit-content", margin:"auto", }}>
  ...
  <div className="holder">
    ...
    <p>An NFT marketplace is an online platform or website where users can buy, sell, and trade non-fungible tokens
      (NFTs). These marketplaces serve as digital marketplaces specifically designed for the exchange of unique digital
      assets.</p>
    <p>Here's how an NFT marketplace typically functions:</p>
    <ol>
      <li>
  ...
  {/* <script>
    ...
    const p = document.querySelector('p.slide-up');
    observer.observe(p);
  </script> */}
</body>
